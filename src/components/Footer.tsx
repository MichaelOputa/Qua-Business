        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              <img
                ...
                alt="QUA Business"
                className="h-12 w-12 object-cover rounded-xl ring-1 ring-white/20"
              />
            ...
            <div className="flex items-center gap-3">
              {socials.map(({ Icon, href, label }) => (
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-cyan-500 hover:text-slate-950 transition-colors"
                >
                  <Icon size={16} />
                </a>
              ))}
              ...
              {serviceLinks.map((s) => (
                <li key={s}>
                  <button
                    ...
                    className="text-slate-400 text-sm hover:text-cyan-400 transition-colors text-left"
                  >
                    {s}
                  </button>
                </li>
          ...
          <div>
            ...
            <a
              ...
              className="mt-6 inline-flex items-center gap-2 bg-gradient-to-r from-cyan-400 to-blue-500 text-slate-950 text-sm font-bold px-5 py-2.5 rounded-full hover:shadow-lg hover:shadow-cyan-500/30 transition-all"
            >
